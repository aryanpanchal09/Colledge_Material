<nav class="navbar navbar-expand-lg navbar-dark bg-black">
            <div class="container-fluid px-4 px-lg-5 ">
                ...
                <img src="./uploads/1.png" width="30" height="30" class="d-inline-block align-top" alt="" loading="lazy">
                Trends
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link text-white" aria-current="page" href="./" style="display: flex;">
                        <img src="./uploads/house.png" width="20px" height="20px" style="margin-right: 6px;">
                        Home</a></li>
                        <?php 
                       ...
                       <li class="nav-item dropdown">
                        ...
                        <?php endwhile; ?>
                        <?php if($count_cats > 3): ?>
                        <li class="nav-item"><a class="nav-link text-white" href="./?p=view_categories" style="display:flex; font-size: 14px;">
                        <img src="./uploads/categories.png" width="20px" height="20px" style="margin-right: 6px;">
                        All Categories</a></li>
                        <?php endif; ?>
                        <li class="nav-item"><a class="nav-link text-white" href="./?p=about"> 
                          <img src="./uploads/team.png" width="20px" height="20px" style="margin-right: 6px;">
                        About</a></li>
                    </ul>
                    <div class="d-flex align-items-center">
                      <?php if(!isset($_SESSION['userdata']['id'])): ?>
                        <button class="btn btn-outline-dark ml-2 text-light" id="login-btn" type="button"><img src="./uploads/user.png" width="30px" height="30px">&nbsp;Login</button>
                        <?php else: ?>
                        <a class="mr-2 nav-link text-white" href="./?p=cart">
                            <i class="bi-cart-fill me-1"></i>
                            <img src="./uploads/shopping-cart.png" width="25px" height="25px">
                            Cart
