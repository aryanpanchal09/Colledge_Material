...
<section class="py-0">
    ...
    <div class="row">
        <div class="col-lg-2 px-1 border-right text-sm position-sticky bg-blue">
            <h4 style="text-align: center;">
            <img src="./uploads/brand-image.png" width="30px" height="30px">
            <b>Brands</b></h4>
            <ul class="list-group">
        ...
        <div class="col-lg-10 py-2">
            ...
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-4 row-cols-md-3 row-cols-xl-4 ">
                    ...
                    ?>
                    <div class="col mb-5">
                        <a class="card text-dark" href=".?p=view_product&id=<?php echo md5($row['id']) ?>">
                            <!-- Product image-->
                            <img class="card-img-top w-100" height="300px" style="object-fit: contain;" src="<?php echo validate_image($img) ?>" alt="..." />
                            <!-- Product details-->
